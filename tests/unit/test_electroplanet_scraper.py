...
async def test_webscraping_agent_includes_electroplanet_products(monkeypatch) -> None:
    ...
    for provider in ("avito", "electrosalam", "mafiawaystore", "moteur", "mymarket", "ultrapc", "jumia", "defacto", "biougnach", "marjane", "decathlon", "mubawab", "ikea", "palmarosa", "bringo", "planetsport"):
